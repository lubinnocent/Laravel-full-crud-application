  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{url('product')}}"><i class="fa fa-microchip"></i> <span>Products</span></a></li>
...
<script>
  ...
  $('#edit').on('show.bs.modal', function (event) {
      ...
      var product_name = button.data('myproductname') 
      var product_price = button.data('myproductprice') 
